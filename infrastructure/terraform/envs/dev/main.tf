...
variable "github_repo" {
  description = "Repositório GitHub para WIF"
  type        = string
...
variable "backend_image" {
  ...
  type        = string
  default     = "southamerica-east1-docker.pkg.dev/agente-ai-dev/agente-ai/api:latest"
}

variable "web_image" {
  description = "Imagem do frontend para Cloud Run"
  type        = string
  default     = "southamerica-east1-docker.pkg.dev/agente-ai-dev/agente-ai/web:latest"
}

variable "ingest_image" {
  description = "Imagem do job de ingestão"
  type        = string
  default     = "southamerica-east1-docker.pkg.dev/agente-ai-dev/agente-ai/ingest:latest"
}
